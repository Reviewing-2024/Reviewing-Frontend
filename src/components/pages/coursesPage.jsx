...
const CoursesPage = () => {
    ...
    useEffect(() => {
        ...
        setHasMore(true);
        fetchItems(true);
    }, [platform, category, sortCriteria]);
    ...
    const fetchItems = useCallback(async (isInitialLoad = false) => {
        ...
        try {
            ...
            const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/courses/${platform}/${category}`, {
                headers,
                params,
            });
    ...
    }, [loading, hasMore, sortCriteria, lastCourseId, lastRating, lastComments, platform, category, token]);
