                        ...
                        <div key={item.id} className='review-card'>
                            <div className="myreview-content">
                                <Link 
                                    ...
                                    onClick={() => fetchCourseDetails(item.courseId)}
                                    to={`/reviews/${item.courseId}`} 
                                    state={{ item }}   
                                >
                                    {item.courseTitle} <FaExternalLinkAlt />
                                </Link>
                                <span className={`status ${item.status.toLowerCase()}`}><BsCircleFill /></span>
